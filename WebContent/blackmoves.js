var side="black";              // side=1 means you are white else black;
var board=new Array(8);
var possible_moves=new Array(64);
var kings_loc;
var our_turn;
var check;                                   //to check if opposition king is under check
var mate;                                 //to check if opposition king is mate
var stalemate=false;
var select =true;
...
function myFunction(xml) 
{
  ...
  if(piece!=6||start_column-loc_column==1||start_column-loc_column==-1)
  {
	  ...
	  document.getElementById("111").innerHTML=piece;
	  if(start==56)
  ...
  {
	  var r = confirm("you are mate, press ok to get back to home page ");
	  if (r == true) 
	  {
